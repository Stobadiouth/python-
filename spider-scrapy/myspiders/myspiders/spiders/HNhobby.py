...
from myspiders.items import HNHobby
from scrapy.conf import settings

class HnhobbySpider(scrapy.Spider):
    name = 'HNhobby'
    ...
    def parse(self, response):
        ...
        item["food"] = response.xpath("/html/body/div[3]/div[3]/div[3]/div[2]/ul[2]/li[2]/text()")[0].extract().strip()
        item["music"] = response.xpath('/html/body/div[3]/div[3]/div[3]/div[2]/ul[3]/li[1]/text()')[0].extract().strip()
        item["film"] = response.xpath("/html/body/div[3]/div[3]/div[3]/div[2]/ul[2]/li[3]/text()")[0].extract().strip()
        item["book"] = response.xpath('/html/body/div[3]/div[3]/div[3]/div[2]/ul[1]/li[3]/text()')[0].extract().strip()
        item["pet"] = response.xpath('/html/body/div[3]/div[3]/div[3]/div[2]/ul[3]/li[3]/text()')[0].extract().strip()
