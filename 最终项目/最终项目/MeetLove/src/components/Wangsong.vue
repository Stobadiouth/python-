<template>
  <div id="example">
    ...
    <select v-model="city" class="selectTravelCity" title="Select Travel Destination" @change="updatemessage">
      <option v-for="option in cityArr" :value="option.name">
        {{ option.name }}
      </option>
    </select>
    <div   class="selectTravelCity a" v-text="district" ></div>
