<template>
    <div id="example">
      <select v-model="prov" class="selectTravelCity" title="Select Travel Destination">
        <option v-for="option in arr" :value="option.name">
          {{ option.name }}
        </option>
      </select>
      <select v-model="city" class="selectTravelCity" title="Select Travel Destination">
        <option v-for="option in cityArr" :value="option.name">
          {{ option.name }}
        </option>
      </select>
      <input type="text" class="a selectTravelCity" placeholder="请输入你的学校" v-model="district" @change="updatemessage">
  ...
  export default {
    ...
    methods: {
      ...
      updatemessage:function () {
        let b=this.prov+this.city+"市"+this.district ;
...
.selectTravelCity
  {
    ...
    border-radius            : 0.2em;
    box-shadow               : inset 0 0 3px rgba(153, 153, 153, 0.65);
...
.selectTravelCity:focus {box-shadow: 0 0 3px 2px #F23A6E;}
